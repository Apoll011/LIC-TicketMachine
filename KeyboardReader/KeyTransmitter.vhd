...
architecture behavioral of KeyTransmitter is
    ...
    signal sr_load    : std_logic;   -- carrega shift register
    signal sr_out     : std_logic;   -- bit série do shift register
    signal txclk_rise : std_logic;   -- flanco ascendente de TXclk
    signal txd_force  : std_logic;   -- '0'=notificação, '1'=idle
    signal txd_sel    : std_logic;   -- '0'=forçado, '1'=shift register
    signal txd_int    : std_logic;   -- saída final de TXD
